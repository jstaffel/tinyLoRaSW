...
/*!
 * Test Pin GPIO_3 for testing timer functionaliy
 */
...
{ 
  ...
  //  TimerSetValue( &LedBeaconTimer, 5000 );
    ...
    /* Application won't use low power off mode, for better debugging */
